...
Local structural indexes may contain full source text and absolute device paths even when their input repository is public. Keep their databases, manifests, raw results, logs, and corpus mappings outside public Git and outside promoted shared knowledge. Do not expose corpus-changing or unrestricted query tools to an onboarding or maker role.
