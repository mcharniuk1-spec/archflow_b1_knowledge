...
Structural indexes provide generated evidence, not requirements authority. Any local index must use an explicit corpus, remain ignored, expose read-only bounded operations by default, and return sanitized repository-relative references.
